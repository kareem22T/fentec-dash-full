<x-filament-widgets::widget>
    <x-filament::section>
        <form target="_blank" action="http://api.uqbike.com/terControl/sendControl.do?token=E4A663AD4406DA768300D4EA20BCC4CF&paramName=15&controlType=control" method="POST">
            <h1 style="font-weight: bold; text-align: center">Unlock Battary</h1>
